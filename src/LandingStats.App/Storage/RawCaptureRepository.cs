...
public sealed class RawCaptureRepository
{
        ...
        IReadOnlyList<string> controlInputSources)
    {
        ...
        {
            writer.WriteLine($"Generated by MSFS Landing Stats {ApplicationVersion()} by {ApplicationAuthor()}");
            ...
            writer.WriteLine($"control_input_source_count={controlInputSources.Count.ToString(CultureInfo.InvariantCulture)}");
            for (var index = 0; index < controlInputSources.Count; index++)
            {
                writer.WriteLine($"control_input_source_{index.ToString(CultureInfo.InvariantCulture)}={SingleLine(controlInputSources[index])}");
            }
        }
    }
    ...
    private static string ApplicationAuthor()
    {
        var assembly = typeof(RawCaptureRepository).Assembly;
